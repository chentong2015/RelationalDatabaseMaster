...
You need to be careful here, since its across scopes.
...
This lets you specify which table you want the value from, in case the two above arent quite what you need (very rare).
